...
// Update Course
void updateCourse(Course& course, const std::string& courseID, const std::string& classID, const std::string& name, const std::string& teacher, const std::string& cre, const std::string& day, const std::string& ss, std::string &outStr); // Inputbox
// Update Scoreboard
