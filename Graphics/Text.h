...
struct Text {
	...
	Text();
	Text(const char* text, float fsize = text_const::size, Font font = LoadFontEx(text_const::font_path, 256, 0, 0), float space = text_const::space, Color color = text_const::color);
